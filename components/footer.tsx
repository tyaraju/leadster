      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-row px-14 justify-between pt-[3px] pb-[43px]">
          <div className="grid-cols-3 basis-1/4 md:min-w-[300px]">
            <p className="color-copy-default font-JakartaSansBold text-[18px] mb-[43px]">Links Principais</p>
            <ul className="">
              <li>
          ...
          <div className="grid-cols-3 basis-1/4 md:min-w-[300px]">
            <p className="color-copy-default font-JakartaSansBold text-[18px] mb-[43px]">Cases</p>
            <ul>
              <li>
          ...
          <div className="grid-cols-3 basis-1/4 md:min-w-[300px]">
            <p className="color-copy-default font-JakartaSansBold text-[18px] mb-[43px]">Materiais</p>
            <ul>
              <li>
          ...
          <div className="grid-cols-3 basis-1/4">
            <p className="color-copy-default font-JakartaSansBold text-[18px] mb-[22px]">Siga a Leadster</p>
            <div className="f_social_icon flex flex-row mb-[27px]">
              <a target="_blank" className='linkedin' href="https://www.linkedin.com/company/leadster-platform/">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="14px" width="14px" xmlns="http://www.w3.org/2000/svg">
              ...
              <a target="_blank" className='instagram' href="https://www.instagram.com/leadster.com.br/">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="17px" width="17px" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="widget-wrap mt-2">
              <p className="color-copy-default font-JakartaSans text-[15px] mb-[11px]">Email: <a href='mailto:contato@leadster.com.br' className=''>contato@leadster.com.br</a></p>
              <p className="color-copy-default font-JakartaSans text-[15px]">Telefone: <a href='tel:+55(0)42-98828-9851' className=''>(42) 98828-9851</a></p>
            </div>
          </div>
        </div>
      </div>
