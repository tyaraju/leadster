...
interface HeaderProps {
  setChecked: boolean;
  handleDarkmode: (event:Event) => void;
}
    ...
    <header className={`w-full z-50 bg-white dark:bg-dark-black ${scrollPosition > 50 ? 'fixed slide-in' : ''}` }> 
      <div className="p-header z-50 w-full py-[10px] sm:py-[20px] lg:py-[42px] flex-nowrap justify-between flex ">
        ...
        <div className="grid-cols-8 flex justify-center bg-white dark:bg-dark-black">
          <a
            className="logo pointer-events-none flex place-items-center gap-2 p-8 pointer-events-auto p-0"
          ...
          <Image
            src="/images/logo.png"
            alt="Leadster Logo"
            className="invertImage w-full h-auto"
            width={194}
            height={92}
          />
          </a>
          ...
          <input type="checkbox" id="darkmode-toggle" defaultChecked={props.setChecked} onChange={(e) => props.handleDarkmode(e)}/>
